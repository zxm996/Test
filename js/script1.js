...
$(window).ready(function(){
  $(".swiper1-img1").mouseenter(function(){
    $(".swiper1-box2-text1").animate({
      left:'30px',
      opacity:"1",
    },1000);
    $(".swiper1-box2-text2").animate({
      right:'50px',
      opacity:"1",
    },1000);
  });
  $(".swiper1-img2").mouseenter(function(){
    $(".swiper1-box2-text3").animate({
      left:'30px',
      opacity:"1",
    },1000);
    $(".swiper1-box2-text4").animate({
      right:'50px',
      opacity:"1",
    },1000);
  });
  $(".swiper1-img3").mouseenter(function(){
    $(".swiper1-box2-text5").animate({
      left:'30px',
      opacity:"1",
    },1000);
    $(".swiper1-box2-text6").animate({
      right:'50px',
      opacity:"1",
    },1000);
  });
  $(".swiper1-img4").mouseenter(function(){
    $(".swiper1-box2-text7").animate({
      left:'30px',
      opacity:"1",
    },1000);
    $(".swiper1-box2-text8").animate({
      right:'50px',
      opacity:"1",
    },1000);
  });
